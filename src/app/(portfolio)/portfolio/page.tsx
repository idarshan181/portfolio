...
export default async function Portfolio(props: IPortfolioProps) {
  ...
  return (
    <div className="h-[70vh] bg-background text-foreground">
      <p className="text-foreground">{t('presentation')}</p>
      ...
      <div className="mt-5 text-center text-sm">
        ...
        <Link
          className="text-foreground hover:border-b-2 hover:border-blue-700"
